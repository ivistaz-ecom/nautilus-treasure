...
export default function QASession() {
  const questions = [
    {
      id: 1,
      text: "1. What is Nautilus Shipping's primary service?",
      options: ["Ship Management", "Crew Management", "Commercial Services"],
      correctAnswer: "Ship Management",
    },
    {
      id: 2,
      text: "2. How many vessels does Nautilus Shipping manage?",
      options: ["50 vessels", "100 vessels", "150 vessels"],
      correctAnswer: "50 vessels",
    },
    {
      id: 3,
      text: "3. What is the size of Nautilus Shipping's seafarer database?",
      options: ["5,000+ seafarers", "10,000+ seafarers", "20,000+ seafarers"],
      correctAnswer: "20,000+ seafarers",
    },
    {
      id: 4,
      text: "4. What is Nautilus Shipping’s core focus in their ship management service?",
      options: [
    ...
    {
      id: 5,
      text: "5. Which type of vessels does Nautilus Shipping primarily manage?",
      options: ["Cargo Ships", "Oil Tankers", "Bulk Carriers"],
      correctAnswer: "Bulk Carriers",
    },
    {
      id: 6,
      text: "6. What geographical regions does Nautilus Shipping serve?",
      options: ["North America", "Europe and Asia", "Global"],
      correctAnswer: "Global",
    },
    {
      id: 7,
      text: "7. Select one of the options for annual crewing costs:",
      options: [
    ...
    {
      id: 8,
      text: "8. What are the hidden cost percentages in crewing?",
      options: ["20%", "30%", "40%"],
      correctAnswer: "30%",
    },
  ];
            ...
            {!submitted ? (
              <>
                ...
                <div className="flex justify-between mt-16">
                  {step > 0 && (
                    <button
                      className="px-4 py-2 bg-[#2894b5] rounded hover:bg-[#03313F] text-white border"
                      ...
                      <button
                        className={`px-4 py-2 rounded ${
                          selectedAnswers[questions[step].id]
                            ? "bg-[#2ac1ef] text-white hover:bg-[#03313F] border"
